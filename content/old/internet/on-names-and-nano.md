...
First, as you probably failed to notice when you clicked into the comments on the pages, there's a new name for this site, in terms of ways to get to it: [www.offby1.net](http://www.offby1.net). The old offlineblog.com address won't stop working, so worry not, but offby1.net is now the preferred URL, and all links on the site will point to it, as soon as I figure out how to walk my MySQL database and convert all of the old URLs.
